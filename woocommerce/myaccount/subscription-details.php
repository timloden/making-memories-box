...
?>
<table class="shop_table subscription_details table">
    <tbody>
        <tr>
            ...
            <td>
                <div class="wcs-auto-renew-toggle">
                    ...
                    <a href="#" class="<?php echo esc_attr( implode( ' ' , $toggle_classes ) ); ?>"
                        aria-label="<?php echo esc_attr( $toggle_label ) ?>"><i
                            class="subscription-auto-renew-toggle__i" aria-hidden="true"></i></a>
